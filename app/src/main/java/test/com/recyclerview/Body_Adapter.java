...
public class Body_Adapter extends RecyclerView.Adapter<Body_Adapter.MyHolder> {

    private ArrayList<String> dateList = new ArrayList<>();
    private Context mContext;

    public Body_Adapter(Context context){
        this.mContext = context;
    }

    @Override
    public MyHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(mContext).inflate(R.layout.body_item_layout, parent, false);
